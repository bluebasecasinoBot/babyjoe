        ...
        [
            ...
            __c(
                ...
                [
                    ...
                    __SYD.meme_stickers({size:201, rotate:3,  img:"meme3"}),
                    __SYD.meme_stickers({size:112, rotate:56, img:""}),
                    ...
                    __SYD.meme_stickers({size:60,  rotate:65, img:""}),
                    __SYD.meme_stickers({size:213, rotate:57, img:""}),
                    __SYD.meme_stickers({size:94,  rotate:12, img:""}),
                    __SYD.meme_stickers({size:187, rotate:33, img:""}),
                    __SYD.meme_stickers({size:239, rotate:0, img:"meme5"}),
                    __SYD.meme_stickers({size:141, rotate:8,  img:""}),
                    __SYD.meme_stickers({size:122, rotate:44, img:""}),
                    __SYD.meme_stickers({size:250, rotate:21, img:""}),
                    __SYD.meme_stickers({size:98,  rotate:0,  img:""}),
                    __SYD.meme_stickers({size:176, rotate:61, img:""}),
                    __SYD.meme_stickers({size:109, rotate:38, img:""}),
                ]
            )
        ]
    )
