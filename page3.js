...
__SYD.page3 = () =>{
    return __c(
        "div",
        {
            style:`height:100vh;width:100vw;position:fixed;top:0;left:0;background:rgba(0 , 0 , 0 , .4);;display:${__p(["page3" , "close"],true) ? "none" : "flex"};align-items:center;justify-content:center;`
        },
        [
            __SYD.close_meme(),
            __c(
